...
class mystique_Skin extends Skin
{
	...
	function get_param_definitions( $params )
	{
		...
		$set = array(
			...
			'twitter_consumer_key' => array(
				'label' => $this->T_('Twitter consumer key'),
				'note' => $this->T_('Your Twitter App Consumer Key.'),
				'defaultvalue' => '4TxR2UmwGoccGwx03YzAMQ',
				'type' => 'text',
				'size' => 70,
			),
			'twitter_consumer_secret' => array(
				'label' => $this->T_('Twitter consumer secret'),
				'note' => $this->T_('Your Twitter App Consumer Secret.'),
				'defaultvalue' => 'L1IErVTp0tXwcsL8Y4aNTqGZXg6oj7tD4GzTU03iPM',
				'type' => 'text',
				'size' => 70,
			),
			'twitter_user_token' => array(
				'label' => $this->T_('Twitter user token'),
				'note' => $this->T_('Your Twitter App Access Token.'),
				'defaultvalue' => '163652772-42eMqVYWdmOePE8TD4ug789Bq3VP8PaOKBo4Oqzb',
				'type' => 'text',
				'size' => 70,
			),
			'twitter_user_secret' => array(
				'label' => $this->T_('Twitter Token Secret'),
				'note' => $this->T_('Your Twitter App Access Token Secret.'),
				'defaultvalue' => 'fccLxPMHVWJtSi0bnyEdREPlCS0rhG8sWL7WWzKBonBXz',
				'type' => 'text',
				'size' => 70,  
			),
			'4_end' => array(
	...
	<script type="text/javascript" src="resources/jquery.mystique.js"></script><script type="text/javascript" src="twitter/jquery.tweet.min.js"></script>');
	...
	function cache_interval()
	{ 
	
		return $cache_interval = 15;
	...
	function cache_dir()
	{
		...
		return $cache_dir = 'twitter/';
	
	}
	
	function twitter_construct() {
...
if($_POST) {
	//$this->get_setting('twitter_user_secret') $this->get_setting('twitter_user_token') $this->get_setting('twitter_consumer_secret') $this->get_setting('twitter_consumer_key')
		$tmhOAuth = new tmhOAuth(array(
			'host'                  => $_POST['request']['host'],
			'consumer_key'          => $this->get_setting('twitter_consumer_key'),
			'consumer_secret'       => $this->get_setting('twitter_consumer_secret'),
			'user_token'            => $this->get_setting('twitter_user_token'),
			'user_secret'           => $this->get_setting('twitter_user_secret'),
